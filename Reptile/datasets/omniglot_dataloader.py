...
class OmniglotDataset(dataset.Dataset):
    ...
    pairs.
    """
    _BASE_PATH = './datasets/omniglot_resized'
    ...
    def __init__(self, num_support, num_query):
        ...
        # shuffle characters
        np.random.shuffle(self._character_folders)
...
def get_omniglot_dataloader(
    ...
    Args:
        ...
        num_way (int): number of classes per task
        num_support (int): number of support examples per class
        num_query (int): number of query examples per class. Set this to 15.
        num_tasks_per_epoch (int): number of tasks before DataLoader is
            exhausted. Set this to num_tasks * num_epochs.
    """
