...
def main(args):
    ...
    checkpoint = torch.load(f'model_ckpt/ProtoNet_{args.model}_{args.datasets}_{args.num_ways}w_{args.num_shots}s_best.pth')
    ...
    for test_batch, _ in testloader:
        loss, acc = protonet(args, test_batch, is_train=False)
