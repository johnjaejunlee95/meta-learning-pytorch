...
class DataSampling():
    def __init__(self, args):
        ...
        max_steps = {'train' : args.epoch, 'valid': args.max_test_task, 'test': args.max_test_task} #*self.n_cluster*args.batch_size
        ...
        self.m_sampler = {
            stage: DatasetSampler(args,
                                  ...
                                  n_way= args.num_ways_proto if stage == 'train' else args.num_ways, k_shot=args.num_shots + args.num_shots_test,
